...
def generate_prompt():
    ...
    if data.get("selectedTemplate") == "Bejaardenhuis":
        ...
        template_info = """
        [Thuasne Quatro Rollator] in een [typische Nederlandse woonwijk of straat], weergegeven in een hyperrealistische buitensetting met zacht, natuurlijk daglicht. De straat moet visueel rijk zijn met levensechte details zoals bakstenen huizen met zichtbare voegen, licht verweerde stoeptegels, subtiele schaduwen van planten of fietsen, zachte reflecties op ramen, en lichte textuur op de banden van de rollator. Zorg dat het product goed zichtbaar en scherp gepositioneerd is, met ongeveer 2/4 lege ruimte aan de rechterzijde van het beeld voor het toevoegen van USP’s of tekst. De compositie moet vertrouwd en toegankelijk zijn, met eventueel subtiele elementen zoals een geparkeerde fiets, bloembakken of tuinhekjes op afstand — maar zonder visuele afleiding of verkeer. Gebruik een cinematische scherpte-diepte, realistische schaduwen, en natuurlijke imperfecties om een echt straatbeeld na te bootsen. Afbeeldingsgrootte: 2000 x 2000 pixels.  Genereer eerst voor jezelf een afbeelding met product en stuur mij de afbeelding zonder product erin kan dat?
        """
